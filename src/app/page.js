...
export default function Home() {
    ...
    return (
        <Box width="100vw" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center" bgcolor="gray">
            <Stack direction="column" width="500px" height="900px" border="1px solid black" p={2} spacing={3} bgcolor="white">
